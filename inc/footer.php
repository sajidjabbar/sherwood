            ...
            <div class="row align-items-center">
                <div class="col-lg-7">
                    <div class="heading">
                        ...
                        <p>uspendisse mollis ante imperdiet, dictum sapien eu, suscipit turpis. Curabitur enim purus,
                            dignissim non</p>
                    </div>
                </div>
                <div class="col-lg-5">
                    <div class="newsletter_box">
                        <div class="form-group">
                            <input type="email" placeholder="Your Email Addrress" class="form-control">
            ...
            <div class="col-lg-5 p-0 m-0">
                <div class="footer-content scnd-content">
                    ...
                    <ul class="footer-link">
                        <li><a href="#">SHERWOOD PARTNERS</a></li>
                        <li><a href="#">SHERWOOD FINANCE</a></li>
                        <li><a href="#">WELLNESS REVIEW</a></li>
                        <li><a href="#">AGENCY IP</a></li>
                        <li><a href="#">lIQUIDATION TRUST AGENTS | DISTRIBUTION AGENTS</a></li>
                        <li><a href="#">WHEN YOU WANT IT DONE RIGHT, THE FIRST TIME </a></li>
                    </ul>
                </div>
            </div>
...
<!--                        </li>-->
                        ...
                        <li><a href="mailto:INFO@SHERWOODPARTNERS.COM">INFO@SHERWOODPARTNERS.COM</a></li>
                        <li><a href="#"><img src="img/linkedin.png" class="img-fluid"></a></li>
                    </ul>
                </div>
            </div>
        </div>
